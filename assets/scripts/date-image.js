function updateDateImage() {
    ...
    n === 2 && e === 14 ? t = "./assets/seasonal/val.avif" :
        n === 4 && e === 1 ? t = "./assets/seasonal/teapot.avif" :
            n === 10 && e === 31 ? t = "./assets/seasonal/spiderweb.avif" :
                n === 12 && e >= 1 && e <= 30 ? t = "./assets/seasonal/ch.gif" :
                    n === 10 && e === 3 ? t = "./assets/images/boi.jpg" :
                    n === 6 && e === 5 ? t = "./assets/seasonal/tree.png" :
                        t;
    document.getElementById("dateImage").src = t;
}
